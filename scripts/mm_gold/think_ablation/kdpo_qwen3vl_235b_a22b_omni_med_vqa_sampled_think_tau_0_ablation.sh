...
torchrun --nproc_per_node=8 \
         ...
         --teacher_model_name_or_path Qwen/Qwen3-VL-235B-A22B-Instruct \
         ...
         --output_dir /mnt/task_runtime/output/MM-GOLD/Qwen3-VL-2B-KDPO-MRI-600-think-tau-0-235b-a22b \
         --num_train_epochs 5 \
         --alpha 0.0 \
         --tau 0.0 \
         --save_strategy steps \
         ...
         --run_name Qwen3-VL-2B-KDPO-MRI-600-think-tau-0-235b-a22b \