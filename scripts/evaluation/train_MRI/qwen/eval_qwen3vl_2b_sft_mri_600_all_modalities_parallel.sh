...
# Example usage: bash scripts/evaluation/train_MRI/qwen/eval_qwen3vl_2b_sft_mri_600_all_modalities_parallel.sh

# Model configuration
MODEL_PATH="/mnt/task_runtime/output/SFT/Qwen3-VL-2B-Instruct-SFT-MRI-600"
MODEL_NAME="Qwen3-VL-2B-Instruct-SFT-MRI-600"
BATCH_SIZE=16
MODE="nothink"
