...
# Example usage: bash scripts/evaluation/train_MRI/qwen/eval_qwen3vl_2b_kepo_think_gpu4_adaptive_v1_tau_1_mri_600_all_modalities_parallel.sh

# Model configuration
MODEL_PATH="/mnt/task_runtime/output/MM-GOLD/Qwen3-VL-2B-KEPO-MRI-600-think-gpu4-adaptive-v1-tau-1"
MODEL_NAME="Qwen3-VL-2B-KEPO-MRI-600-think-gpu4-adaptive-v1-tau-1"
BATCH_SIZE=16
MODE="think"
