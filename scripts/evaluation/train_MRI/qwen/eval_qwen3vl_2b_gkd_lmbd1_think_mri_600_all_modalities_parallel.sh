...
# Example usage: bash scripts/evaluation/train_MRI/qwen/eval_qwen3vl_2b_gkd_lmbd1_think_mri_600_all_modalities_parallel.sh

# Model configuration
MODEL_PATH="/mnt/task_runtime/output/MM-GOLD/Qwen3-VL-2B-GKD-lmbd1-MRI-600-think"
MODEL_NAME="Qwen3-VL-2B-GKD-lmbd1-MRI-600-think"
BATCH_SIZE=16
MODE="think"
