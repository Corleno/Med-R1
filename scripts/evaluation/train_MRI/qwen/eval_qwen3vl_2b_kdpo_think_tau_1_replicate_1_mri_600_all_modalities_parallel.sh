...
# Example usage: bash scripts/evaluation/train_MRI/qwen/eval_qwen3vl_2b_kdpo_think_tau_1_replicate_1_mri_600_all_modalities_parallel.sh

# Model configuration
MODEL_PATH="/mnt/task_runtime/output/MM-GOLD/Qwen3-VL-2B-KDPO-MRI-600-think-tau-1-replicate-1"
MODEL_NAME="Qwen3-VL-2B-KDPO-MRI-600-think-tau-1-replicate-1"
BATCH_SIZE=16
MODE="think"
