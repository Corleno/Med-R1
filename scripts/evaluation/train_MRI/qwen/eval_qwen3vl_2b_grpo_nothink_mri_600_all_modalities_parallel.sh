...
# Example usage: bash scripts/evaluation/train_MRI/qwen/eval_qwen3vl_2b_grpo_nothink_mri_600_all_modalities_parallel.sh

# Model configuration
MODEL_PATH="/mnt/task_runtime/output/MM-GOLD/Qwen3-VL-2B-GRPO-MRI-600-nothink"
